		...
		<div v-if="selectedOption === 'add'">
			...
			>
				...
				<p class="text-sm text-gray-500">
					使用Tips：銷售訂單通過標籤頁，可以一站式完成所有銷售業務流程
				</p>
				...
				>
					...
					<el-form-item label="訂單簽訂日期" class="w-3/4">
						<el-date-picker
							v-model="returnDate"
							type="date"
							style="width: 100%"
					...
					<el-form-item label="訂單交付日期" class="w-3/4">
						<el-date-picker
							v-model="returnDate"
							type="date"
							style="width: 100%"
				...
				>
					...
					<el-form-item label="銷售產品明細" class="xl:col-span-3">
						<div class="w-full">
							<!-- 表格 -->
							<el-table
							...
							>
								...
								/>
								<!-- 可編輯欄位 -->
								<el-table-column label="已出庫-銷售數量" width="150">
									<template #default="scope">
										<el-input
								...
								/>
								<!-- 可編輯欄位 -->
								<el-table-column label="未出庫-銷售數量" width="150">
									<template #default="scope">
										<el-input
				...
				>
					<el-form-item label="已出庫-銷售產品總數">
						<el-input disabled placeholder="暫無內容" />
					</el-form-item>
					<el-form-item label="已出庫-銷售產品售價總額(含稅)/元">
						<el-input disabled placeholder="暫無內容" />
					</el-form-item>
...
const detailsColumns = ref([
	...
	{ prop: 'returnDate', label: '訂單申請日期', minWidth: 130 },
	{ prop: 'returnReason', label: '訂單原因', minWidth: 100 },
	{ prop: 'returnWarehouse', label: '訂單倉庫', minWidth: 100 },
	{
	...
	{ prop: 'outReturnTotalQty', label: '已出庫-訂單產品總數', minWidth: 100 },
	{
		prop: 'outReturnTotalPrice',
		label: '已出庫-訂單產品售價總額(含稅)/元',
		minWidth: 180,
		align: 'right',
		headerAlign: 'left',
	},
	...
	{ prop: 'inspectionResult', label: '訂單產品收穫檢驗', minWidth: 100 },
...
// 快捷表格欄位
const cvColumns = ref([
	{ prop: 'outReturnQty', label: '已出庫-訂單數量' },
	{ prop: 'notOutReturnQty', label: '未出庫-訂單數量' },
]);
// 確認選擇
