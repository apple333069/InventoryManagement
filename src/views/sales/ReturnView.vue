		...
		<div v-if="selectedOption === 'add'">
			...
			>
				...
				>
					...
					<el-form-item label="退貨申請日期" class="w-3/4">
						<el-date-picker
							v-model="returnDate"
							type="date"
							style="width: 100%"
					...
					<el-form-item label="銷售退貨單編號" class="w-3/4">
						<el-input
							v-model="form.salesReturnID"
							disabled
				...
				<el-form
					...
					class="grid grid-cols-1 xl:grid-cols-3 gap-x-16 py-7 px-2 font-bold"
				>
					<el-form-item label="退貨原因" :required="true">
						<el-select
							v-model="value1"
							placeholder="請選擇退貨原因"
							class="w-full"
					...
					<el-form-item label="退貨產品明細" class="xl:col-span-3">
						<div class="w-full">
							<!-- 表格 -->
							<el-table
							...
							>
								...
								/>
								<!-- 可編輯欄位 -->
								<el-table-column label="已出庫-退貨數量" width="150">
									<template #default="scope">
										<el-input
											v-model="scope.row.outReturnQty"
											placeholder="輸入數量"
											type="number"
											class="w-full"
										/>
								...
								/>
								<!-- 可編輯欄位 -->
								<el-table-column label="未出庫-退貨數量" width="150">
									<template #default="scope">
										<el-input
											v-model="scope.row.notOutReturnQty"
											placeholder="輸入數量"
											type="number"
											class="w-full"
										/>
				...
				>
					<el-form-item label="已出庫-退貨產品總數">
						<el-input disabled placeholder="暫無內容" />
					</el-form-item>
					<el-form-item label="已出庫-退貨產品售價總額(含稅)/元">
						<el-input disabled placeholder="暫無內容" />
					</el-form-item>
...
const detailsColumns = ref([
	...
	{ prop: 'returnDate', label: '退貨申請日期', minWidth: 130 },
	{ prop: 'salesReturnID', label: '銷售退貨單編號', minWidth: 130 },
	{ prop: 'returnReason', label: '退貨原因', minWidth: 100 },
	{ prop: 'returnWarehouse', label: '退貨倉庫', minWidth: 100 },
	{
	...
	{ prop: 'outReturnTotalQty', label: '已出庫-退貨產品總數', minWidth: 100 },
	{
		prop: 'outReturnTotalPrice',
		label: '已出庫-退貨產品售價總額(含稅)/元',
		minWidth: 180,
		align: 'right',
		headerAlign: 'left',
	},
...
// 快捷表格欄位
const cvColumns = ref([
	{ prop: 'outReturnQty', label: '已出庫-退貨數量' },
	{ prop: 'notOutReturnQty', label: '未出庫-退貨數量' },
]);
// 確認選擇
